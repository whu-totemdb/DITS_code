...
import java.util.TreeMap;
    ...
    public TreeMap<Long, HashSet<Integer>> postinglist;
    ...
    public void setPostinglist(TreeMap<Long, HashSet<Integer>> pl){
        postinglist = new TreeMap<>();
        postinglist = pl;
    }
    public TreeMap<Long, HashSet<Integer>> getPostinglist(){
        return postinglist;
    }

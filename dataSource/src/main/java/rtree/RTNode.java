...
public abstract class RTNode {
    public RTree rtree; // 结点所在的树

    public int level; // 结点所在的层
    public Rectangle[] datas; // 相当于条目
    public RTNode parent; // 父节点
    public int usedSpace; // 结点已用的空间
    public int insertIndex; // 记录插入的搜索路径索引
    public int deleteIndex; // 记录删除的查找路径索引

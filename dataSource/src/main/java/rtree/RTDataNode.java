...
//        System.out.print("    "+usedSpace+",   "+rtree.getNodeCapacity()+"    ");
...
//            System.out.print("1."+isRoot()+" ");
//            System.out.println(rectangle.getLow().data[0]+", "+rectangle.getLow().data[1]+";"+rectangle.getHigh().data[0]+", "+rectangle.getHigh().data[1]);
            RTDataNode[] splitNodes = splitLeaf(rectangle);
//            System.out.print("2."+isRoot());
            RTDataNode l = splitNodes[0];
            RTDataNode ll = splitNodes[1];
//            System.out.print("3."+isRoot());
            if (isRoot()) {
                // 根节点已满，需要分裂。创建新的根节点

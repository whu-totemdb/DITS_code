...
public class RTree {
    ...
    public int tree_type; // 树类型
    public int nodeCapacity = -1; // 结点容量
    public float fillFactor = -1; // 结点填充因子 ，用于计算每个结点最小条目个数
    ...
    public static void traverse(RTDirNode root){
        List<RTNode> list = root.children;
        System.out.println("root? "+root.isRoot());
        for (RTNode r1: list){
            System.out.println(r1.isIndex()+", "+r1.isRoot()+", "+r1.isLeaf());
    ...
    public static void main(String[] args) throws Exception {
        // 结点容量：4、填充因子：0.4、树类型：二维 6,8,10,11
        RTree tree = new RTree(6, 0.5f, Constants.RTREE_QUADRATIC, 2);
        // 每一行的四个数构成两个点（一个矩形）
        float[] f = { 5, 30, 25, 35,     15, 38, 23, 50,   10, 23, 30, 28,
                13, 10, 18, 15,      23, 10, 28, 20,   28, 30, 33, 40,
                38, 13, 43, 30,      35, 37, 40, 43,   45, 8, 50, 50,
                };

//                23, 55, 28, 70,      10, 65, 15, 70,   10, 58, 20, 63,
//                10, 58, 20, 63,   10, 58, 20, 63,   10, 58, 20, 63,
//                10, 58, 20, 63,   10, 58, 20, 63,
        ...
        for (int i = 0; i < f.length;) {
            ...
            final Rectangle rectangle = new Rectangle(p1, p2, String.valueOf(count));
        ...
        Rectangle[] rect1 = tree.root.datas;
